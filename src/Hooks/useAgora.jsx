...
const temptoken = '006fe911605b2f6467faf4e846035abab80IAA/sh04GpuP+tax97RzYeQLSYcCRg49MQB03jI23qlykmnabjEAAAAAEABGxiZqeU4iYQEAAQB5TiJh'
const chan = 'Elliot'
...
export default function useAgora(client) {
  ...
  async function join(appid , channel , token, uid) {
    ...
    await client.join(appId, chan, temptoken);
